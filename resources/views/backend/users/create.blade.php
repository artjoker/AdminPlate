...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">@lang('backend.create_user')</li>
    </ol>
    <!-- end breadcrumb -->

    <!-- begin page-header -->
    <h1 class="page-header">@lang('backend.create_user') </h1>
    <!-- end page-header -->
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => route('backend.users.store'), 'class' => 'form-horizontal', 'method'=>'POST','data-parsley-validate' => true,'autocomplete'=>'off']) !!}
